...
<?php
	...
	function show_test($test_number)
	{
		...
		{
			$count = $count + 1;
			$question = str_replace("%blank%", "<input maxlength=\"30\" style=\"width:100px; border:0; border-bottom:1px solid #ccc; text-align:center;\" type=\"text\" name=\"q".$count."\" value=\"".$_POST['q'.$count]."\">".$wrong_anwser[$count-1]."", $question);
				...
				<table class="info_table" cellspacing="0px">
					<tr>
						...
						<td class="text_td">
							...
							<p>Thank you for taking part in <strong>English in Dublin\'s FREE Online Tests</strong>.
		...
		<div  style="border:1px solid #ccc;" class="info_block first_info_block">
			<table style="padding:0 0 50px 0;" class="info_table" cellspacing="0px">
				<tr>
					...
					<td style="background-color:#fff; line-height:20px; padding:0px 40px 20px 0px;" class="text_td">
						<p style="font-weight:bold; font-size:18px; padding-top:20px;">
						Welcome to English in Dublin\'s Free Online Tests 2013.
						</p>
						<p>
						...
						<p>
						Each test of 2013 has 20 questions. The answer to each question is one word. 
