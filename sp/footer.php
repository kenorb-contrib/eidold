...
echo'
	...
	<div class="footer_mini_block">tel: +353 1 6614791</div>
	...
	<div class="footer_inner_frame">
		...
		<div class="footer_mini_block">
		<p class="company_p">Reconocido por el Ministerio de Educación y Ciencia como una Escuela de Inglés para la enseñanza del Inglés como Lengua Extranjera. Director: Denis O\'Donoghue, Dionne O\'Donoghue. 
...
<script type="text/javascript" src="jquery.home_slide_show.js"></script>

<script type="text/javascript">
	$.simpleSlideShow("#slide_show");
	$.aboutDublinSlideShow("#about_dublin_slide_show_imgs");
	$.homeSlideShow("#home_slide_blk");
</script>
</div><!--end of content-->
